...
namespace nopCommerceWebApiClient.Objects.Product
{
    ...
    public record ProductDto
    {
        ...
        /// ### Set the SKU
        /// </summary>
        public virtual string Sku { get; init; }
        ...
        /// </summary>
        public virtual int TaxCategoryId { get; init; }
        ...
        /// #### To set mesasures go to Configuration → Shipping → Measures 
        /// </summary>
        public virtual decimal Length { get; init; }
        ...
        /// #### To set mesasures go to Configuration → Shipping → Measures 
        /// </summary>
        public virtual decimal Width { get; init; }
